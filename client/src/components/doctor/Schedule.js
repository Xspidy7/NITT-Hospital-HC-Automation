import styles from '../Student/Doctors.module.css'
            ...
            <div className="row justify-content-between">
                ...
                <div className="col-5">
                    <form className="d-flex" role="search">
                        <input className="form-control me-2" type="number" placeholder="Roll/PF Number" onChange={event => setQuery(event.target.value)} aria-label="Search"/>
                    </form>
                </div>
            </div>
